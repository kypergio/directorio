        ...
        <div class="x_content">
          ...
          <form id="editUserdetails" name="editUserdetails" enctype="multipart/form-data"  method="POST" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('user.update', $userData->id) }}">
          	...
          	<div class="form-group label-floating is-select">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Agregar a usuario como <span class="required">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
	                <select class="form-control col-md-7 col-xs-12" name="userType" id="userType" required >
	                    <option value="2" {{ ($userData->type == 2) ?'selected="selected"':'' }} >Doctor</option>
	                    <option value="3" {{ ($userData->type == 3) ?'selected="selected"':'' }} >Clinic</option>
	                </select>
            	</div>
                <div class="error">{{ $errors->first('userType') }}</div>
            </div>
            <div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Email (será su login) <span class="required">*</span>
				</label>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="email" id="email" readonly class="form-control col-md-7 col-xs-12" name="email" value="{{ $userData->email }}">
            ...
            <div class="form-group">
				...
				<div class="">
					<input minlength="2" maxlength="30" type="text" id="name" required="required" value="{{ $userData->name }}" class="form-control col-md-7 col-xs-12" name="name">
           	...
           	<div class="form-group">
				...
				<div class="">
					<input minlength="10" maxlength="25" type="text" id="contact" required="required" class="form-control col-md-7 col-xs-12" name="contact" value="{{ $userData->phone }}">
            ...
            <div class="form-group">
				...
				<div class="">
					<input type="text" id="website"  class="form-control col-md-7 col-xs-12" name="website" value="{{ $userData->website }}">
            ...
            <div class="form-group">
				...
				<div class="">
					<textarea required minlength="20" class="form-control col-md-7 col-xs-12" name="description" id="description">{{ $userData->description }}</textarea>
            ...
            <div class="form-group">
				...
				<div class="">
					<textarea required minlength="20" class="form-control col-md-7 col-xs-12" name="specialization" id="specialization">{{ $userData->specialization }}</textarea>
            ...
            <div class="form-group">
				...
				<div class="">
					<textarea required minlength="20"  class="form-control col-md-7 col-xs-12" name="about" id="about">{{ $userData->about }}</textarea>
            ...
            <div class="form-group">
	            ...
	            @if($userData->image)
	            <div class="row"><br>
	            	<img src="{{ url('/public/uploads/userimage/'.$userData->id.'/'.$userData->image) }}" alt="" style="width: 150px;border: 1px solid #dcdcdc;">
	            </div>
	            @endif
            </div>
            </div>
            <div class="col-md-6">
            	...
            	<div class="row">
                            <label><i class="fa fa-clock-o  margin-right-10px"></i> Horarios</label>
                            <table class="table table-striped table-bordered">
                                ...
                                <?php 
                                $daysArr = array('mon' => 'Lunes', 'tue'  => 'Martes', 'wed' => 'Miércoles', 'thu'  => 'Jueves', 'fri' => 'Viernes', 'sat' => 'Sábado', 'sun' => 'Domingo');
                                ...
                                foreach ($daysArr as $key => $value) {
                                    ...
                                    $getUserTimings = ($usertimings) ? $usertimings->{$key.'Timing'}:'';
                                    $getUserTimings = ($getUserTimings) ? explode('-', $getUserTimings): '';

                                    ?>
                                    <tr>
                                        <td><input type="checkbox" name="<?php echo $key;?>AvailableStatus" id="<?php echo $key;?>AvailableStatus" <?php echo ($getUserTimings && $usertimings->{$key.'Status'}) ? 'checked':''; ?>  ></td>
            ...
            <div class="form-group">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div><small>Selecciona tu locación en el mapa o escribe tus datos</small></div>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="form-group col-md-12">
						...
						<div class="">
							<input minlength="3" onchange="geocodeAddress();" required type="text" id="address"  class="form-control col-md-12 col-xs-12" name="address" value="{{ $userData->address }}">
		            ...
		            <div class="form-group col-md-6">
						...
						<div class="">
							<input onchange="geocodeAddress();" type="text" id="street"  class="form-control col-md-12 col-xs-12" name="street" value="{{ $userData->street }}">
		            ...
		            <div class="form-group col-md-6">
						...
						<div class="">
							<input onchange="geocodeAddress();" type="text" id="colony"  class="form-control col-md-12 col-xs-12" name="colony" value="{{ $userData->colony }}">
		            ...
		            <div class="form-group col-md-6">
						...
						<div class="">
							<input onchange="geocodeAddress();" type="text" id="state"  class="form-control col-md-12 col-xs-12" name="state" value="{{ $userData->state }}">
		            ...
		            <div class="form-group col-md-6">
						...
						<div class="">
							<input onchange="geocodeAddress();" type="text" id="city"  class="form-control col-md-12 col-xs-12" name="city" value="{{ $userData->city }}">
		            ...
		            <div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" id="latitude" required  class="form-control col-md-12 col-xs-12" name="latitude" value="{{ $userData->lat }}">
		            ...
		            <div class="form-group col-md-6">
						...
						<div class="">
							<input type="text" id="longitude" required  class="form-control col-md-12 col-xs-12" name="longitude" value="{{ $userData->lng }}">
