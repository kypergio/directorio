...
<head>
    ...
    <title>Ultherapy</title>
    <link href="/ultherapy/favicon.ico" rel="icon">
    <link rel="stylesheet" href="/ultherapy/styles.css">
    <link rel="stylesheet" href="/ultherapy/custom.css">
...
<div id="offcanvas" class="c-offcanvas js-offcanvas">
            ...
            <div class="c-navigation__links">
                <div class="c-navigation__nav">
                    <ul class="c-navigation__nav_list">
                        <li><a href="#" class="icon js-lightbox__open">
                                <svg width="22px" height="20px" viewBox="0 0 22 20" version="1.1"
                                     xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <defs>
                                        <linearGradient x1="0%" y1="-43.6936937%" x2="141.921397%" y2="132.732733%"
                                                        id="linearGradient-1">
                                            <stop stop-color="#ED8B00" offset="0%"></stop>
                                            <stop stop-color="#F7D285" offset="100%"></stop>
                                        </linearGradient>
                                        <linearGradient x1="0%" y1="-43.6936937%" x2="140.476048%" y2="130.935979%"
                                                        id="linearGradient-2">
                                            <stop stop-color="#ED8B00" offset="0%"></stop>
                                            <stop stop-color="#F7D285" offset="100%"></stop>
                                        </linearGradient>
                        ...
                        <li><a rel="canonical" href="https://ultherapy.mx/como-funciona-un-lifting-facial-sin-cirugia">Cómo
                                funciona</a></li>
                        <li><a rel="canonical" href="https://ultherapy.mx/beneficios-lifting-facial-sin-cirugia">Antes y
                                después</a></li>
                        <li><a href="https://ultherapy.mx/resultados-lifting-facial">Resultados</a></li>
                        <li><a href="https://ultherapy.mx/como-identificar-un-tratamiento-ulthera-original">El
                                Original</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="c-navigation c-navigation--mobile">
        ...
        <a href="https://ultherapy.mx">
            <img src="https://ultherapy.mx/images/ultherapy_logo_mobile.png" class=""
                 alt="Ultherapy, la evolución del lifting" title="Haz que tu rostro luzca más joven con Ultherapy">
        </a>
    </div>
...
<script src="/ultherapy/index.js" type="text/javascript" charset="utf-8" async defer></script>
