...
: bicubic;display: block;max-width: 90px;background:#fff;" src="<?php echo url('public/front');?>/assets/img/logo-1.png" alt="" ></div>
	...
	<p>Su solicitud ha sido enviada con éxito. Por favor, haga clic en el enlace a continuación para ver el perfil más detalles.
	<br>
	<p style="text-align:center;"><a style="font-size:120%;font-weight:bold;padding:0.5em 1em;background-color:orange;color:#fff;text-decoration:none;border-top-left-radius:5px 5px;border-top-right-radius:5px 5px;border-bottom-left-radius:5px 5px;border-bottom-right-radius:5px 5px;cursor:pointer;" href="<?php echo $profilelink; ?>" target="_blank" title="" >Detalles del perfil</a></p>
	<br><br>
	<!--
